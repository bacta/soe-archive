 ...
 * <p>
 * This message wraps a GameNetworkMessage that was sent from the client, so that it may be passed on to another
 * server. It holds a list of networkIds which should receive the response to the message.
 */
@Getter
@Priority(0x05)
@AllArgsConstructor
