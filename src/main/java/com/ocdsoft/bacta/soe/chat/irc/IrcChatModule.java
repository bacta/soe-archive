package com.ocdsoft.bacta.soe.chat.irc;
 ...
 *
 * IrcChatModule connects the ChatServerProxy to an external IRC server.
 */
public class IrcChatModule implements ChatModule {
    @Override
